...
switch ($request_method) {
   ...
   {
      global $mysqli;
      $query="SELECT mahasiswa.nim, mahasiswa.nama, mahasiswa.alamat, 
      mahasiswa.tanggal_lahir, matakuliah.kode_mk, matakuliah.nama_mk, 
      matakuliah.sks, perkuliahan.nilai 
      FROM perkuliahan 
   ...
   function delete_nilai($id, $kode_mk)
   {
      global $mysqli;
      $query="DELETE FROM perkuliahan WHERE nim= '$id' AND kode_mk= '$kode_mk'";
