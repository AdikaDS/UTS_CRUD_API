...
<?php
 ...
 curl_setopt($curl, CURLOPT_URL, 'http://localhost/uts_api/mahasiswa_api.php?nim='.$nim.'&kode_mk='.$kode_mk.'');
 $res = curl_exec($curl);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add student grades to database.</p>
